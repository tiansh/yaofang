...
; (async function () {
  ...
  i18n.aboutText = {
    cn: '{{logo}}当前扩展正在开发之中，如欲贡献代码请联系 {{scriptWeibo}}。',
    tw: '{{logo}}當前擴充套件正在開發，如慾參與編碼或翻譯工作請聯絡 {{scriptWeibo}}。',
    en: '{{logo}} This extension is under construction. Please contact {{scriptWeibo}} if you want contribute coding or translations.',
  };
